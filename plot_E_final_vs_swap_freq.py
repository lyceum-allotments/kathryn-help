...
T_index_lookup = {0.1 : 0, 0.2 : 1, 0.5 : 2, 1.0 : 3}

for r in results:
    index = T_index_lookup[r["swap_freq"]]
...
plt.xlabel('$f_{\mathrm{swap}}$')
plt.ylabel('$E_{min}$')
fig.subplots_adjust(left=0.15)
plt.savefig("E_final_vs_f_swap.png", bbox_inches = 'tight', dpi=200) 
